...
void _settingsModelSerialize(
  ...
  writer.writeBool(offsets[1], object.minimizeToTray);
}
...
SettingsModel _settingsModelDeserialize(
  ...
  object.minimizeToTray = reader.readBool(offsets[1]);
  return object;
}
...
extension SettingsModelQueryProperty
  ...
  QueryBuilder<SettingsModel, bool, QQueryOperations> minimizeToTrayProperty() {
    return QueryBuilder.apply(this, (query) {
